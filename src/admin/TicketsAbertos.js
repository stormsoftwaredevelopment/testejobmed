...
class TicketsAbertos extends Component{
    ...
    componentDidMount(){
        axios.get('http://localhost/jobmed/api/v1/controller/admin/teste/ticket.php?&item=exibirticketaberto')
        .then(res=>{
    ...
    render(){
        return(
            ...
            <td>{row.id}</td>
                ...
                <td>{row.solucao}</td>
                <td>{row.status}</td>
                <td><Button style={{backgroundColor:'#640080',color:'#ffffff'}}>Encerrar</Button></td>
